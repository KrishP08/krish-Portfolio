...
const projects = [
  {
    title: "ONLINE SMART CLASS",
  description: "A smart class web platform providing live lectures, assignments, and discussion forums for students and teachers. Built for interactive and accessible online education.",
  ...
  {
     title: "VYOM - NASA Data Explorer",
      description: "Vyom is a modern web application that lets users explore various NASA datasets and services including Astronomy Picture of the Day (APOD), Asteroids data, Earth imagery, Satellites, Ground Stations, and more.",
      tech: ["Next.js", "Tailwind CSS", "TypeScript", "NASA API"],
      status: "Completed",
      github: "#",
      demo: "#",
  ...
  },
  {
    ...
    status: "Completed",
    github: "#",
    demo: "https://krish-portfolio-nu.vercel.app/",
    image: "/Portfolio.png?height=400&width=600",
    featured: true,
  },
  {
     title: "AIR MOUSE WITH ESP32",
      description: "A gesture-based air mouse built using ESP32 and MPU6050 to control the cursor using hand movements. It offers wireless control for smart systems and PC navigation.",
      tech: ["ESP32", "MPU6050", "C++", "Bluetooth"],
      status: "Completed",
      github: "#",
      demo: "#",
  ...
  },
  {
    ...
    description:"An interactive card battle game with multiplayer features, custom card designs, and real-time gameplay.",
  ...
  {
    title: "OBSTACLE AVOIDING ROBO CAR",
    description: "An autonomous robotic car designed to detect and avoid obstacles in real time using ultrasonic sensors. Ideal for smart mobility and robotics projects.",
    tech: ["Arduino", "C++", "Ultrasonic Sensor", "IR Sensor"],
    status: "Completed",
    github: "#",
    demo: "#",
    image: "/placeholder.svg?height=400&width=600",
